...
int main() {
    char pt_delta_str[] = "0010000000000000";
    char ct_delta_str[] = "1011001111100000"; // 
    int num_rounds = 4; // num of rounds
    ...
    uint64_t nums_key = 1ULL << 5; // num of keys
    uint64_t nums_msg = 1ULL << 25; // num of messages per key

    printf("LBlocks Differential experiment: 2^%.1f messages for each of 2^%.1f keys, rounds = %d\n",
